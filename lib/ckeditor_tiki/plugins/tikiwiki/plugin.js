 ...
 * $Id: plugin.js 46286 2013-06-12 12:14:24Z lphuberdeau $
 *
...
CKEDITOR.plugins.add('tikiwiki',{
	...
	toHtmlFormat: function ( editor, data ) {
		...
		var output = "";
		var twplugin = this;
		var isHtml = $("input[name=allowhtml]:checked", editor.element.$.form).length ||
			($("input[name=allowhtml][type=hidden]", editor.element.$.form).length &&
				$("input[name=allowhtml][type=hidden]", editor.element.$.form).val() ? 1 : 0);
